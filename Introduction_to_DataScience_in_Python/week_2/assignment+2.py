...
Original file is located at
    https://colab.research.google.com/drive/1vM92n07Re786Sataj0bKZWLKOnUtJTuK
...
def answer_three():
    possible = df[(df['Gold']>=1) & (df['Gold.1']>=1)]
    total_gold = possible['Gold'] + possible['Gold.1'] + possible['Gold.2']
    maxi = (possible['Gold'] - possible['Gold.1']).abs() / total_gold
    return maxi.argmax()
...
def answer_six():
    top_threes = census_df.groupby(census_df['STNAME'])['CENSUS2010POP'].nlargest(3)
